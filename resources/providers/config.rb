  ...
  begin
    ...
    if is_manager
      template "#{pipelines_dir}/vault/00_input.conf" do
        ...
        ignore_failure true
        cookbook 'logstash'
        variables(topics: ['rb_vault', 'rb_limits'])
        notifies :restart, 'service[logstash]', :delayed unless node['redborder']['leader_configuring']
      end
    ...
    if is_manager
      template "#{pipelines_dir}/sflow/00_input.conf" do
        ...
        ignore_failure true
        cookbook 'logstash'
        variables(topics: ['sflow', 'rb_limits'])
        notifies :restart, 'service[logstash]', :delayed unless node['redborder']['leader_configuring']
      end
    ...
    if is_manager
      template "#{pipelines_dir}/netflow/00_input.conf" do
        ...
        ignore_failure true
        cookbook 'logstash'
        variables(topics: ['rb_flow', 'rb_limits'])
        notifies :restart, 'service[logstash]', :delayed unless node['redborder']['leader_configuring']
      end
    ...
    if is_manager
      template "#{pipelines_dir}/scanner/00_input.conf" do
        ...
        ignore_failure true
        cookbook 'logstash'
        variables(topics: ['rb_scanner', 'rb_limits'])
        notifies :restart, 'service[logstash]', :delayed unless node['redborder']['leader_configuring']
      end
    ...
    if is_manager
      template "#{pipelines_dir}/mobility/00_input.conf" do
        ...
        ignore_failure true
        cookbook 'logstash'
        variables(topics: ['rb_location', 'rb_limits'])
        notifies :restart, 'service[logstash]', :delayed unless node['redborder']['leader_configuring']
      end
    ...
    if is_manager
      template "#{pipelines_dir}/intrusion/00_input.conf" do
        ...
        ignore_failure true
        cookbook 'logstash'
        variables(topics: ['rb_event', 'rb_limits'])
        notifies :restart, 'service[logstash]', :delayed unless node['redborder']['leader_configuring']
      end
